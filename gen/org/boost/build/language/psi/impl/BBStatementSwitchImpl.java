...
public class BBStatementSwitchImpl extends ASTWrapperPsiElement implements BBStatementSwitch {

  public BBStatementSwitchImpl(ASTNode node) {
    super(node);
  }
  ...
  public BBCases getCases() {
    return findNotNullChildByClass(BBCases.class);
  }
