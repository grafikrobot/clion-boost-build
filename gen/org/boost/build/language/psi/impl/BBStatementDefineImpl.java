...
public class BBStatementDefineImpl extends ASTWrapperPsiElement implements BBStatementDefine {

  public BBStatementDefineImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BBVisitor visitor) {
    visitor.visitStatementDefine(this);
  }
