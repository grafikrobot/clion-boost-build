...
public class BBStatementClassImpl extends ASTWrapperPsiElement implements BBStatementClass {

  public BBStatementClassImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BBVisitor visitor) {
    visitor.visitStatementClass(this);
  }
  ...
  @NotNull
  public BBLol getLol() {
    return findNotNullChildByClass(BBLol.class);
  }
