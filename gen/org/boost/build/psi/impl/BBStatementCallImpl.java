...
public class BBStatementCallImpl extends ASTWrapperPsiElement implements BBStatementCall {

  public BBStatementCallImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BBVisitor visitor) {
    visitor.visitStatementCall(this);
  }
