...
public class BBListImpl extends ASTWrapperPsiElement implements BBList {
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof BBVisitor) ((BBVisitor)visitor).visitList(this);
    else super.accept(visitor);
  }

  @Override
  @NotNull
  public List<BBArg> getArgList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BBArg.class);
  }
